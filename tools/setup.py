...
def main():
    ...
    print("""
  #######################################
  # F35 Development Environment Setup #
  #######################################

  This script will create your F35 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your F35 project folder:
    [Arma 3 installation directory]\\{} => F35 project folder
    P:\\{}                              => F35 project folder
...
if __name__ == "__main__":
    ...
    if exitcode > 0:
        print("\nSomething went wrong during the setup. Make sure you run this script as administrator. If these issues persist, please follow the instructions on the UKSF wiki to perform the setup manually.")
    else:
